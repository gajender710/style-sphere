      ...
      {products &&
        products.map((product: ProductItem, index: any) => (
          <div
            ...
            className="h-120 w-72 rounded shadow-lg mx-auto border  cursor-pointer"
          >
            <div className="flex items-center justify-center h-72 border-b-2  relative">
              <img
            ...
            <div className="h-48 relative ">
              <span className="font-primary text-primary text-2xl pt-4 px-4 font-semibold">
                {product.title}
              </span>
              ...
              <div
                className="text-primary font-primary font-medium text-base absolute bottom-0 right-0 mb-4 pl-8 pr-4 pb-1 pt-2 bg-palette-lighter 
